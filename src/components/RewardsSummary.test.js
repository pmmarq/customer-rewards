...
describe('RewardsSummary', () => {
  ...
  it('renders nothing when given an empty transaction list', () => {
    const { container } = render(<RewardsSummary transactions={[]} />);

    const summary = container.querySelector('.rewards-summary');
